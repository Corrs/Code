         	...
         	<form class="form-horizontal form-label-left" id="saveForm" method="post" action="<c:out value="${sessionScope.basePath }"></c:out>/sys/content/save">
               ...
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="title" name="title" class="form-control col-md-7 col-xs-12" autocomplete="off" placeholder="输入网站标题">
                 </div>
               </div>
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="bgcolor" readonly="readonly" name="bgcolor" class="colorpicker form-control col-md-7 col-xs-12 " autocomplete="off" value="#FFFFFF" placeholder="选择主题颜色">
                 </div>
               </div>
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="offer" name="offer" class="form-control col-md-7 col-xs-12" autocomplete="off" placeholder="输入优惠信息，如：恭喜{phone}获得优惠信息">
                 </div>
               </div>
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="buy" name="buy" class="form-control col-md-7 col-xs-12" autocomplete="off" placeholder="输入购买信息，如：用户{phone}在9分钟前订购了（两件99元）">
                 </div>
               </div>
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="prop2" name="prop2" class="form-control col-md-7 col-xs-12" autocomplete="off" placeholder="输入表单提交提示信息">
                 </div>
               </div>
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="radio">
                     <label>
                       <input type="radio" checked="" value="0" name="inuse"> 未启用
                     </label>
                     <label>
                       <input type="radio" value="1" name="inuse"> 启用
                     </label>
                   </div>
                 </div>
               </div>
               <div class="item form-group">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <input type="text" id="footerbgcolor" readonly="readonly" name="footerbgcolor" class="colorpicker form-control col-md-7 col-xs-12 " autocomplete="off" value="#FFFFFF" placeholder="选择主题颜色">
                 </div>
               </div>
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12">
                   <!-- <input type="text" id="footercontent" name="footercontent" class="form-control col-md-7 col-xs-12" autocomplete="off" placeholder="输入底部信息"> -->
                     <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editor-one">
	                  ...
	                  <div id="editor-one" class="editor-wrapper" style="overflow: auto"></div>
