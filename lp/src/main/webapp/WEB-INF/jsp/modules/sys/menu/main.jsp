...
<%@ include file="/WEB-INF/jsp/static.jsp" %>
    ...
    <div class="x_panel jrwl_custom_panel">
     <div class="col-md-12 col-sm-12 col-xs-12">
       <div class="x_panel jrwl_custom_listpanel">
         <div class="x_title">
           <h2>菜单管理<a id="fade-link" href="#" title="树面板伸缩"><i class="fa fa-times fa-fw"></i></a></h2>
         ...
         <div class="row">
        	<div class="x_content jrwl_custom_listcontent">
	         	<div id="treePanel" class="col-md-2 jrwl_custom_treecontent">
	         		<div id="treeview-checkable"></div>
	         	</div>
        		<div id="tablePanel" class="col-md-10">
		           <div id="toolbar">
		           		<button id="append" class="btn btn-info" title="新增" disabled><i class="fa fa-plus fa-fw"></i>新增</button>
				        <!-- <a class="btn btn-primary" disabled><i class="fa fa-pencil fa-fw"></i>编辑</a> -->
   ...
   <script src="<c:out value="${sessionScope.basePath }"></c:out>/plugins/bootstrap-table-develop/dist/tableExport.js"></script>
   <script src="<c:out value="${sessionScope.basePath }"></c:out>/modules/sys/menu/main.js"></script>
